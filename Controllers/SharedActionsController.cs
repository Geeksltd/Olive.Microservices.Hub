namespace Controllers
{
    ...
    public class SharedActionsController : BaseController
    {
        ...
        public async Task<ActionResult> HealthCheck()
            => Content($"Health check @ {LocalTime.Now.ToLongTimeString()}, " +
        ...
        public async Task<ActionResult> HealthCheckAll([FromServices] IHealthCheckService healthCheckService)
            => Content(await healthCheckService.HealthCheckAll(), "text/html");

        [Route("healthcheck/alert")]
        public async Task<ActionResult> HealthCheckAlert([FromServices] IHealthCheckService healthCheckService)
            => Content(await healthCheckService.HealthCheckAlert());
