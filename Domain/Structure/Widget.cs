namespace Olive.Microservices.Hub
{
    ...
    public partial class Widget : GuidEntity, IComparable<Widget>, ISortable
    {
        ...
        /// <summary>Gets or sets the value of Group on this Widget instance.</summary>
        [System.ComponentModel.DataAnnotations.StringLength(200)]
        ...
        public Board Board
        {
            ...
            set
            {
                ...
                if (value != null) value.Widgets.Add(this);
            }
        }
        ...
        protected override Task ValidateProperties()
        {
            ...
            if (Group?.Length > 200)
                result.Add("The provided Group is too long. A maximum of 200 characters is acceptable.");
